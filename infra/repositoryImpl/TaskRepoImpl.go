...
var _ repository.TaskRepo = &TaskRepoImpl{}

func NewTaskRepo(dao dao.TaskDao, convert converter.TaskConverter) repository.TaskRepo {
	return &TaskRepoImpl{
		Dao:     dao,
		Convert: convert,
	}
...
func (t *TaskRepoImpl) SaveTask(ctx context.Context, task *entity.Task) error {
...
func (t *TaskRepoImpl) UpdateTaskStatus(ctx context.Context, task *entity.Task) error {
...
func (t *TaskRepoImpl) UpdateTaskDueDate(ctx context.Context, task *entity.Task) error {
...
func (t *TaskRepoImpl) UpdateTaskDescription(ctx context.Context, task *entity.Task) error {
...
func (t *TaskRepoImpl) UpdateTaskName(ctx context.Context, task *entity.Task) error {
...
func (t *TaskRepoImpl) FindDueTasksByStatus(ctx context.Context, status int) ([]*entity.Task, error) {
...
func (t *TaskRepoImpl) FindDueTaskPerson(ctx context.Context, auid string, status int) ([]*entity.Task, error) {
